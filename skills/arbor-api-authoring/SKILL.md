...
5. Create or update YAML under the workspace's `collections/`, `environments/`, and `scenarios/` directories. Add descriptions explaining purpose, inputs, authentication, responses, and assumptions. Replace or remove the `example` scaffold once real resources exist.
